...
const ColorPicker = ({ selectedColor, onChange }) => {
  ...
  return (
    ...
    transition-all px-3 py-2 rounded:lg"
      >
        <Palette size={16} /> <span className="max-sm:hiddden">Accent</span>
      </button>
      {isOpen && (
        <div
        ...
        >
          {colors.map((color) => (
            ...
            >
              <div
                className={
                  "w-12 h-12 rounded-full border-2 border-transparent group-hover:border-black/25 transition-colors"
                }
