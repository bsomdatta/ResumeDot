...
const ResumeBuilder = () => {
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      ...
      alert("Share not suppported on this browser.");
    }
  };
  ...
  const saveResume = async () => {
    try {
      ...
      //remove img from updatedRseumeData
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            ...
            >
              ...
              <hr
                className="absolute top-0 left-0 right-0 border-2
              border-gray-200"
              />
              <hr
              ...
              ring-green-300 text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6
              py-2 mt-6 text-sm"
              >
                Save Changes
              </button>
            ...
            <div className="relative w-full ">
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                {resumeData.public && (
                  <button
                    onClick={handleShare}
                    className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100
